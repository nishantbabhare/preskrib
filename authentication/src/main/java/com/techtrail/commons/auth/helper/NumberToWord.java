package com.techtrail.commons.auth.helper;
...
public class NumberToWord {
	...
	private static String[] units = { "Zero", " One", " Two", " Three", " Four", " Five", " Six", " Seven", " Eight",
			" Nine" };
	...
	/*
	 * private void inputNumber() { Scanner in=new Scanner(System.in); try {
	 * System.out.print("Please enter number to Convert into Words : ");
	 * num=in.nextInt(); } catch(Exception e) {
	 * System.out.println("Number should be Less than 1 Arab "); System.exit(1); } }
	 */
	/*
	 * public static void main(String[] args) { NumberToWord obj=new NumberToWord();
	 * // obj.inputNumber();
